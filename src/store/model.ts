...
export type SettingsData={experience?:'cozy'|'simplified'|'modern'|'sumi';theme:string;themeVersion:number;sound:boolean;ambient:boolean;reminders:boolean;browserNotifications?:boolean;familyEventReminders?:boolean;loginDigest?:boolean;scheduleShowAcademic?:boolean;scheduleShowSports?:boolean;scheduleShowAppointments?:boolean;parentMode?:boolean;reducedMotion:boolean;textSize?:'normal'|'large';density?:'comfortable'|'compact';decoration?:boolean;boardStyle?:'paper'|'cork'|'plain';motionPreference?:'system'|'reduced'|'full';sanctuaryWeather:SanctuaryWeather;sanctuaryWeatherMode:WeatherMode;sanctuaryZipCodes:Record<string,string>;sanctuaryWeatherLocations:Record<string,string>}
...
export const defaultSettings:SettingsData={experience:'cozy',textSize:'normal',density:'comfortable',decoration:true,boardStyle:'paper',theme:'coral',themeVersion:4,sound:true,ambient:true,reminders:false,browserNotifications:false,familyEventReminders:false,loginDigest:true,scheduleShowAcademic:true,scheduleShowSports:true,scheduleShowAppointments:true,parentMode:false,reducedMotion:false,motionPreference:'system',sanctuaryWeather:'clear',sanctuaryWeatherMode:'clear',sanctuaryZipCodes:{},sanctuaryWeatherLocations:{}}
