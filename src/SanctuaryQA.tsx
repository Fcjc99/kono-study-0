...
export default function SanctuaryQA() {
 ...
 return <main style={{padding:16,background:'#f8f5ee',minHeight:'100vh'}}>
  ...
  <div style={{width:narrow?375:920,maxWidth:'100%',margin:'16px auto'}}><GardenCard phase={phase} weather="clear" reducedMotion={reduced} progress={progress} homeStyle={homeStyle}/></div>
 </main>
}
